###
# run_pcangsd_by_lg_thin200_500_1000_k2_k12.sh does this:
# Runs PCAngsd per linkage group across three thinning levels (200/500/1000)
# and admixture K values from 2 to 12, writing results in a structured output tree.
###
#!/usr/bin/env bash
set -euo pipefail
source ~/.bashrc
